  ...
  const CreateQuestion = () => {
    ...
    const { professor_id, noQuestions, category, quizId } = location?.state;
    ...
    const handleQuestionSubmit = async (e) => {
      ...
      const quizId = location?.state?.quizId; // Get quizId from location or state
